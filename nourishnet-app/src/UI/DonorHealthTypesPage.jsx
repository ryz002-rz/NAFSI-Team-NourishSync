    ...
    <div className="ft-root">
      ...
      <div className="ft-grid">
        {HEALTH_ATTRS.map((attr) => (
          <button key={attr} className="ft-card" onClick={() => navigate(`/donor/health/${encodeURIComponent(attr)}`)}>
...
export default DonorHealthTypesPage;
